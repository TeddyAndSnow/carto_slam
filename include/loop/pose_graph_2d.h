...
#include "loop/constraint_builder_2d.h"
...
#include "loop/pose_graph_data.h"
...
namespace carto_slam
{
        ...
        namespace loop
        {
                ...
                public:
                        ...
                        void AddImuData(int trajectory_id, const common::ImuData &imu_data) override;                                    //LOCKS_EXCLUDED(mutex_);
                        void AddOdometryData(int trajectory_id, const common::OdometryData &odometry_data) override;                     //LOCKS_EXCLUDED(mutex_);
                        void AddFixedFramePoseData(int trajectory_id, const common::FixedFramePoseData &fixed_frame_pose_data) override; //LOCKS_EXCLUDED(mutex_);
                        void AddLandmarkData(int trajectory_id, const common::LandmarkData &landmark_data) override;                     //LOCKS_EXCLUDED(mutex_);
                        ...
                        common::Rigid3d GetLocalToGlobalTransform(int trajectory_id) const;                                                           //LOCKS_EXCLUDED(mutex_) override;
                        ...
                        std::map<std::string, common::Rigid3d> GetLandmarkPoses() const override;                                                     //LOCKS_EXCLUDED(mutex_);
                        void SetLandmarkPose(const std::string &landmark_id, const common::Rigid3d &global_pose, const bool frozen = false) override; //LOCKS_EXCLUDED(mutex_);
                        common::MapByTime<common::ImuData> GetImuData() const override;                                                               //LOCKS_EXCLUDED(mutex_);
                        common::MapByTime<common::OdometryData> GetOdometryData() const override;                                                     //LOCKS_EXCLUDED(mutex_);
                        common::MapByTime<common::FixedFramePoseData> GetFixedFramePoseData() const override;                                         //LOCKS_EXCLUDED(mutex_);
                        ...
                        common::Rigid3d GetInterpolatedGlobalTrajectoryPose(
                            int trajectory_id, const common::Time time) const; //EXCLUSIVE_LOCKS_REQUIRED(mutex_);
                ...
                private:
                        ...
                        void AddWorkItem(const std::function<common::WorkItem::Result()> &work_item); //LOCKS_EXCLUDED(mutex_) LOCKS_EXCLUDED(work_queue_mutex_);
                        ...
                        NodeId AppendNode(
                            ...
                            const common::Rigid3d &optimized_pose); //LOCKS_EXCLUDED(mutex_);
                        ...
                        void HandleWorkQueue(const ConstraintBuilder2D::Result &result)
                        ...
                        // 'global_submap_poses'.
                        common::Rigid3d ComputeLocalToGlobalTransform(
