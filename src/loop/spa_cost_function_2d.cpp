...
namespace carto_slam
{
  namespace loop
  {
    namespace
    {
                        ...
                        T *e) const
        {
          const std::array<T, 3> error =
              ScaleError(ComputeUnscaledError(
                             common::Project2D(observed_relative_pose_.zbar_ij),
                             start_pose, end_pose),
      ...
      class AnalyticalSpaCostFunction2D : public ceres::SizedCostFunction<3 /* number of residuals */,
      ...
      private:
        const common::Rigid2d observed_relative_pose_;
