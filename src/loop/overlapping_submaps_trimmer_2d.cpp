    ...
    namespace
    {
          ...
          SubmapCoverageGrid2D *coverage_grid)
      {
        ...
        for (const auto &submap : submap_data)
        {
          ...
          const common::Rigid3d &global_frame_from_submap_frame = submap.data.pose;
          const common::Rigid3d submap_frame_from_local_frame =
          ...
          for (const Eigen::Array2i &xy_index : XYIndexRangeIterator(cell_limits))
          {
            ...
            const common::Rigid3d center_of_cell_in_local_frame =
                common::Rigid3d::Translation(Eigen::Vector3d(
                    grid.limits().max().x() -
            ...
            const common::Rigid2d center_of_cell_in_global_frame =
                common::Project2D(global_frame_from_submap_frame *
